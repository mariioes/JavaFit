...
public class Actividad_Especial extends Actividad_Deportiva {
    ...
    public Actividad_Especial(double precio, String descripcion, String titulo, String tipo, Sala sala, Horario horario, String monitor_asignado, int aforo_actual) {
